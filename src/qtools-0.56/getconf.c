...
static void nomem(char *fatal)
{
  strerr_die2x(111,fatal,"out of memory");
}

int getconf(stralloc *sa,char *fn,int flagrequired,char *fatal,char *dir)
{
  int i;
  int j;
  int k;
...
int getconf_line(stralloc *sa,char *fn,int flagrequired,char *fatal,char *dir)
{
