...
#define FATAL "qmail-smtpd-conf: fatal: "
...
{
    strerr_die1x(PERM, "qmail-smtpd-conf: usage: qmail-smtpd-conf acct logacct /smtpd [ ip ]");
}
...
int main (int argc, char **argv)
{
    ...
    outs("    "); outs(auto_qmail); outs("/bin/qmail-smtpd\n");
    outs("'\n");
    finish();
    perm(0755);
