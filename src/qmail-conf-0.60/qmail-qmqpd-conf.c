...
#define FATAL "qmail-qmqpd-conf: fatal: "
...
{
    strerr_die1x(PERM, "qmail-qmqpd-conf: usage: qmail-qmqpd-conf acct logacct /qmqpd [ ip ]");
}
...
int main (int argc, char **argv)
{
    ...
    outs("    "); outs(auto_qmail); outs("/bin/qmail-qmqpd\n");
    outs("'\n");
    finish();
    perm(0755);
